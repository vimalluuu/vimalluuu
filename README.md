...
| 🧠 **Human Scream Detection** | Real-time emergency audio detection using ML and signal analysis. |
| ❄️ **EWSGLOB** | Early Warning System for Glacier Lake Outburst – predictive monitoring model. |
| ✋ **Sign Language Translator** | Real-time hand gesture recognition for accessible communication. |
